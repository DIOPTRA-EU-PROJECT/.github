...
* **Permissive:** Allows for commercial use, modification, and distribution.
* **Patent Grant:** Provides an explicit grant of patent rights from contributors to users.
* **Liability:** Includes standard limitations of liability and warranty protections for the contributors.

---

## EU Funding Acknowledgement
This project has received funding from the European Union’s <b>Horizon Europe</b> research and innovation programme under grant agreement No. <b>101096649</b>.
